...
public class Account {
    ...
    /**
     * When posting a new Account, the id can be generated by the database. In that case, a constructor without account_id is needed.
     * @param username
     * @param password
     */
    ...
    /**
     * Whem retrieving an Account from the database, all fields will be needed. In that case, a constructor with all fields is needed.
     * @param account_id
     * @param username
     * @param password
     */
