...
public class Message {
    ...
    /**
     * The id for the user who has posted this message. We will assume that this is provided by the front-end of this application.
     */
    ...
    /**
     * The epoch time when this tweet was posted (number of seconds since Jan 1, 1970). Longs are large enough to store this number. We will assume that this number is provided by the front-end of this application.
     */
    ...
    /**
     * When posting a new message, the id can be generated by the database. In that case, a constructor without message_id is needed.
     * @param posted_by
     * @param message_text
    ...
    /**
     * Whem retrieving a message from the database, all fields will be needed. In that case, a constructor with all fields is needed.
     * @param message_id
     * @param posted_by
     * @param message_text
     * @param time_posted_epoch
    ...
    /**
     * Overriding the default equals() method adds functionality to tell when two objects are identical, allowing Assert.assertEquals and List.contains to function.
